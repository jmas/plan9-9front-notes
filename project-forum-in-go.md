...
I should be able to run this forum on 9front for development and also it should be optimized for run on hosting [ukraine.com.ua](https://www.ukraine.com.ua/). At the hosting I found [blog post that tells that I can host Go projects there](https://www.ukraine.com.ua/news/hosting/webapp/) and [wiki says how to setup go program](https://www.ukraine.com.ua/wiki/hosting/web-servers/proxying/#go). So my target is to develop the forum completely on 9front and run it on the hosting. Source code of the forum should be hosted at github and CI/CD pipeline via FTP sould build and deploy it on the hosting.
